package core {
    ...
    {
        private static var _instance:BrushModel;
        ...
        public function BrushModel(enforcer:SingletonEnforcer) {}

        public static function get instance():BrushModel {
            if (_instance == null) {
                _instance = new BrushModel(new SingletonEnforcer());
            }
            return _instance;
        }
    }
